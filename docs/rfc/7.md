...
```json
{
  "vct": "https://originator-profile.org/originatorProfile",
      ...
      "organizationJP": {
        ...
        "properties": {
          ...
          "businessCategory": {
            ...
            "items": {
              "type": "string",
              "title": "事業種目 c.f. https://www.soumu.go.jp/toukei_toukatsu/index/seido/sangyo/R05index.htm"
            }
          },
          "contact_title": {
            "title": "連絡先表示名",
...
```json
{
  ...
  "issuer": {
    ...
    "description": {
      "type": "text/plain",
      "text": "この文章は、この組織の OP憲章へのコミットメントを表す文章です。"
    }
  },
  "holder": {
