...
*   Type: `string` ([Detached JSON Web Signature](dp-properties-document-profile-item-document-profile-item-anyof-document-profile-visible-text-properties-proof-properties-detached-json-web-signature.md))
...
`string` ([Detached JSON Web Signature](dp-properties-document-profile-item-document-profile-item-anyof-document-profile-visible-text-properties-proof-properties-detached-json-web-signature.md))
