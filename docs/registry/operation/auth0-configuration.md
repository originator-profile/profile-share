...
1. post login action のスクリプトをペーストしてください。スクリプトは git で管理されています： https://github.com/originator-profile/profile/blob/main/packages/auth0/actions/add-default-role-to-new-user.js
