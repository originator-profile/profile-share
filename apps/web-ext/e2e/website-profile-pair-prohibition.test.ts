...
test("サイトプロファイル検証失敗時に閲覧禁止の確認", async ({
  ...
  await runTest(
    context,
    page,
    "http://localhost:8080/examples/many-dps.html",
  );
});
