...
function WarningDetails() {
  return (
    <div className="pt-3">
      <p>
        Originator Profile ではこのサイトが本物であるかの確認を「認証鍵」という電子証明によって行っています。<br />
      ...
      <br />
        特に 2. の場合はあなたを欺き不利益を与える危険なサイトと考えられます。<br />
        これらの理由によりこのサイトが偽サイトである可能性をあなたにお伝えしています。<br />
        証明書は改ざん・偽装されている可能性があるのでご注意ください。<br />
        ...
        <main className="px-4 py-12">
          ...
          <article className="mb-12 max-w-sm mx-auto">
            <p className="text-sm tracking-normal text-left font-normal">
              本物そっくりの偽サイトにログインしたり個人情報を登録したり支払いをしてしまい被害に合うケースが多発しています。<br />
