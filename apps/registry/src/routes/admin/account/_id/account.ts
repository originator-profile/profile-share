...
const Body = {
  ...
  properties: {
    input: {
      ...
      title: "JSON",
      description: `\
[Prisma.accountsCreateInput](https://docs.originator-profile.org/ts/types/_originator-profile_profile_registry_db.default.Prisma.accountsCreateInput.html)\
 または \
[Prisma.accountsUpdateInput](https://docs.originator-profile.org/ts/types/_originator-profile_profile_registry_db.default.Prisma.accountsUpdateInput.html)\
 を与えます。`,
