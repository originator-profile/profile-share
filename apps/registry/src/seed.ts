...
import exampleAccount from "./account.example.json" assert { type: "json" };
import exampleWebsite from "./website.example.json" assert { type: "json" };
import exampleWebsite2 from "./seeds/website.2.example.json" assert { type: "json" };
